...
public interface CryptoService {
  ...
  Page<CryptoDepositDTO> getDepositsInRange(
  ...
  Page<CryptoDepositDTO> getDepositsByToAddressAndSite(
      String toAddress, String site, Pageable pageable);

  Page<CryptoDepositDTO> getDepositsByFromAddressAndSite(
      String fromAddress, String site, Pageable pageable);

  Page<CryptoDepositDTO> getSendDepositsByCryptoWalletAndSite(
      String cryptoWallet, String site, boolean isSend, Pageable pageable);

  Page<CryptoDepositDTO> getDepositsByToAddressAndIsSendAndSite(
      String toAddress, boolean isSend, String site, Pageable pageable);

  Page<CryptoDepositDTO> getDepositsByFromAddressAndIsSendAndSite(
      String fromAddress, boolean isSend, String site, Pageable pageable);

  // 특정 기간의 전체 입금 목록
  Page<CryptoDepositDTO> getDepositsInRangeBySite(

...
public class ReportController {
  ...
  public ResponseEntity<Page<ReportDTO>> getReportsByLevelAndName(
    ...
    return ResponseEntity.ok()
            .body(reportService.findReportsByEmployeeName(level, employeeId, employeeName, start, end, pageable));
  }
  ...
  public ResponseEntity<Page<ReportDTO>> getReportsByLevelAndDepartment(
    ...
    return ResponseEntity.ok()
            .body(reportService.findReportsByDepartment(level, employeeId, department, start, end, pageable));
  }

  @GetMapping("get/by/level/{level}/employeeId/{employeeId}/employeeName/{employeeName}/department/{department}")
  public ResponseEntity<Page<ReportDTO>> getReportsByLevelAndNameAndDepartment(
    ...
    return ResponseEntity.ok()
        .body(reportService.findReportsByEmployeeNameAndDepartment(level, employeeId, department, employeeName, start, end, pageable));
  }
}
